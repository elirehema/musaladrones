...
@Component
@Service
public interface MedicationWritePlatformService {
    ResponseEntity<?> loadDroneWithMedication(final Long droneId, final Medication medication, MultipartFile file);
}
